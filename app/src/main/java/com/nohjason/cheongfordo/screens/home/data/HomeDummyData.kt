package com.nohjason.cheongfordo.screens.home.data

import com.nohjason.cheongfordo.R

object HomeDummyData {
    val wordCardDataList = listOf(
        Triple("가산금리", "금융 기관에서 대출, 채권 따위의 금리를 결정할 때 기준 금리에 덧붙이는 금리.", R.drawable.ic_star),
        Triple("기준금리", "경제를 안정시키기 위해 중앙은행이 설정하는 금리.", R.drawable.ic_star),
        Triple("변동금리", "시장 상황에 따라 주기적으로 변동하는 금리.", R.drawable.ic_star)
    )
